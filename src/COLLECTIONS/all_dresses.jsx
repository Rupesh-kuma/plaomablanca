...
const Allderesses = () => {
    ...
    useEffect(() => {
        const filters = async () => {
            try {
                const response = await fetch("./data/all_dresses.json");
                if (!response.ok) {
    ...
    return (
        ...
        <div className="row row-cols-1 row-cols-md-2 g-4">
                    <div className="col">
                        <div className="card border-0 bg-transparent">
                            <div className="card-body">
                                <h1 className="card-title">On your wedding day you should feel: <b>you</b></h1>
                            </div>
                        </div>
                    </div>
                    <div className="col border-start">
                        <div className="card border-0 bg-transparent">
                            <div className="card-body">
                                <h3 className="card-title mb-0">Shop</h3>
                                <p className="card-text">Shop</p>
                                <p className="card-text">A selection of veils and hair pieces to complement your Paloma Blanca wedding gown.</p>
                            </div>
                        </div>
                    </div>
